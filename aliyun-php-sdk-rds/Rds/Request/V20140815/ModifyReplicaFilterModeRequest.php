 ...
 */
class ModifyReplicaFilterModeRequest extends \RpcAcsRequest
{
    ...
    {
        $this->requestParameters['FillterDDL'] = $fillterDDL;
        $this->queryParameters['FillterDDL'] = $fillterDDL;
