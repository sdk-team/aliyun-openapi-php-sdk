 ...
 *
 * Request of DescribeArchiveSQLLogFromKepler
 *
 ...
 */
class DescribeArchiveSQLLogFromKeplerRequest extends \RpcAcsRequest
{
    ...
    {
        $this->requestParameters['ArchiveJobID'] = $archiveJobID;
    ...
    /**
     * @param string $ossTableName
     *
     * @return $this
     */
    public function setOssTableName($ossTableName)
    {
        $this->requestParameters['OssTableName'] = $ossTableName;
