 ...
 */
class ModifyReplicaRecoverModeRequest extends \RpcAcsRequest
{
    ...
    {
        $this->requestParameters['RecoverMode'] = $recoverMode;
        $this->queryParameters['RecoverMode'] = $recoverMode;
