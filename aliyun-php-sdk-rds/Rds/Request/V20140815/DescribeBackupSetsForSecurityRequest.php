 ...
 *
 * Request of DescribeBackupSetsForSecurity
 *
...
class DescribeBackupSetsForSecurityRequest extends \RpcAcsRequest
{
    ...
    /**
     * @param string $targetAliBid
     *
     * @return $this
     */
    public function setTargetAliBid($targetAliBid)
    {
        $this->requestParameters['TargetAliBid'] = $targetAliBid;
    ...
    /**
     * @param string $targetAliUid
     *
     * @return $this
     */
    public function setTargetAliUid($targetAliUid)
    {
        $this->requestParameters['TargetAliUid'] = $targetAliUid;
