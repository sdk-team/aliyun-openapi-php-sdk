...
class CreateInstancesRequest extends \RpcAcsRequest
{
    ...
    /**
     * @param string $rebuildInstance
     *
     * @return $this
     */
    public function setRebuildInstance($rebuildInstance)
    {
        $this->requestParameters['RebuildInstance'] = $rebuildInstance;
        $this->queryParameters['RebuildInstance'] = $rebuildInstance;
