...
class ListCompanyRegOrdersRequest extends \RpcAcsRequest
{
    ...
    /**
     * @param string $notBizStatus
     *
     * @return $this
     */
    public function setNotBizStatus($notBizStatus)
    {
        $this->requestParameters['NotBizStatus'] = $notBizStatus;
        $this->queryParameters['NotBizStatus'] = $notBizStatus;
