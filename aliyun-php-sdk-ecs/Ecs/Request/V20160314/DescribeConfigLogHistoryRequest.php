 ...
 *
 * Request of DescribeConfigLogHistory
 *
 ...
 */
class DescribeConfigLogHistoryRequest extends \RpcAcsRequest
{
    ...
    {
        $this->requestParameters['ChronologicalOrder'] = $chronologicalOrder;
        $this->queryParameters['ChronologicalOrder'] = $chronologicalOrder;
