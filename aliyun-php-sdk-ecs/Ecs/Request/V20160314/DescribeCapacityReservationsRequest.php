...
class DescribeCapacityReservationsRequest extends \RpcAcsRequest
{
    ...
    /**
     * @param string $capacityReservationIds
     *
     * @return $this
     */
    public function setCapacityReservationIds($capacityReservationIds)
    {
        $this->requestParameters['CapacityReservationIds'] = $capacityReservationIds;
        $this->queryParameters['CapacityReservationIds'] = $capacityReservationIds;
