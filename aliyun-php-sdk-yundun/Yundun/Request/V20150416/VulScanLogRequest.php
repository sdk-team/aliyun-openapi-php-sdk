 ...
 */
class VulScanLogRequest extends \RpcAcsRequest
{
    ...
    /**
     * @param string $vulStatus
     *
     * @return $this
     */
    public function setVulStatus($vulStatus)
    {
        $this->requestParameters['VulStatus'] = $vulStatus;
        $this->queryParameters['VulStatus'] = $vulStatus;
